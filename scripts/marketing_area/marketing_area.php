...
class marketing_area extends connect {
    private $guardar = 'INSERT INTO marketing_area(id, id_area, id_staff, id_position, id_journey) VALUES (:ID, :ID_1, :ID_2, :ID_3, :ID_4)';
    private $solicitar = 'SELECT id AS "ID", id_area AS "ID_1", id_staff AS "ID_2", id_position AS "ID_3", id_journey AS "ID_4" FROM marketing_area';
    private $actualizar = 'UPDATE marketing_area SET id_area = :ID_1, id_staff = :ID_2,  id_position = :ID_3,  id_journey = :ID_4   WHERE id = :ID';
    private $eliminar = 'DELETE FROM marketing_area WHERE id = :ID';
    use getInstance;
    private $mensaje;
    ...
    public function deleteAll_marketing_area() {
        try {
    ...
    public function postAll_marketing_area() {
        try {
    ...
    public function putAll_marketing_area() {
        try {
